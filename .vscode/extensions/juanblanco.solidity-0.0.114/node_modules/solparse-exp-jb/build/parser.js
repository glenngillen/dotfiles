...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c202 = "catch",
      peg$c203 = peg$literalExpectation("catch", false),
      peg$c204 = "is",
      peg$c205 = peg$literalExpectation("is", false),
      peg$c206 = "indexed",
      peg$c207 = peg$literalExpectation("indexed", false),
      peg$c208 = "import",
      peg$c209 = peg$literalExpectation("import", false),
      peg$c210 = "interface",
      peg$c211 = peg$literalExpectation("interface", false),
      peg$c212 = "internal",
      peg$c213 = peg$literalExpectation("internal", false),
      peg$c214 = "library",
      peg$c215 = peg$literalExpectation("library", false),
      peg$c216 = "mapping",
      peg$c217 = peg$literalExpectation("mapping", false),
      peg$c218 = "memory",
      peg$c219 = peg$literalExpectation("memory", false),
      peg$c220 = "minutes",
      peg$c221 = peg$literalExpectation("minutes", false),
      peg$c222 = "modifier",
      peg$c223 = peg$literalExpectation("modifier", false),
      peg$c224 = "new",
      peg$c225 = peg$literalExpectation("new", false),
      peg$c226 = "null",
      peg$c227 = peg$literalExpectation("null", false),
      peg$c228 = "private",
      peg$c229 = peg$literalExpectation("private", false),
      peg$c230 = "pragma",
      peg$c231 = peg$literalExpectation("pragma", false),
      peg$c232 = "public",
      peg$c233 = peg$literalExpectation("public", false),
      peg$c234 = "return",
      peg$c235 = peg$literalExpectation("return", false),
      peg$c236 = "returns",
      peg$c237 = peg$literalExpectation("returns", false),
      peg$c238 = "seconds",
      peg$c239 = peg$literalExpectation("seconds", false),
      peg$c240 = "set",
      peg$c241 = peg$literalExpectation("set", false),
      peg$c242 = "solidity",
      peg$c243 = peg$literalExpectation("solidity", false),
      peg$c244 = "storage",
      peg$c245 = peg$literalExpectation("storage", false),
      peg$c246 = "struct",
      peg$c247 = peg$literalExpectation("struct", false),
      peg$c248 = "super",
      peg$c249 = peg$literalExpectation("super", false),
      peg$c250 = "szabo",
      peg$c251 = peg$literalExpectation("szabo", false),
      peg$c252 = "this",
      peg$c253 = peg$literalExpectation("this", false),
      peg$c254 = "throw",
      peg$c255 = peg$literalExpectation("throw", false),
      peg$c256 = "true",
      peg$c257 = peg$literalExpectation("true", false),
      peg$c258 = "using",
      peg$c259 = peg$literalExpectation("using", false),
      peg$c260 = "var",
      peg$c261 = peg$literalExpectation("var", false),
      peg$c262 = "weeks",
      peg$c263 = peg$literalExpectation("weeks", false),
      peg$c264 = "wei",
      peg$c265 = peg$literalExpectation("wei", false),
      peg$c266 = "while",
      peg$c267 = peg$literalExpectation("while", false),
      peg$c268 = "years",
      peg$c269 = peg$literalExpectation("years", false),
      peg$c270 = ";",
      peg$c271 = peg$literalExpectation(";", false),
      peg$c272 = ",",
      peg$c273 = peg$literalExpectation(",", false),
      peg$c274 = function() { return { type: "ThisExpression", start: location().start.offset, end: location().end.offset }; },
      peg$c275 = "(",
      ...
      peg$c286 = function(elements, elision) {
            return {
              type:     "ArrayExpression",
      ...
      peg$c287 = function(elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c288 = function(head, elision, element) {
              return optionalList(extractOptional(elision, 0)).concat(element);
            },
      peg$c289 = function(head, tail) { return Array.prototype.concat.apply(head, tail); },
      peg$c290 = function(commas) { return filledArray(commas.length + 1, null); },
      peg$c291 = function(callee, args) {
                return {
                  type: "NewExpression",
                  callee: callee,
                  arguments: args,
      ...
      peg$c311 = function(literal, members, parts) {
          return {
            type: "Type",
      ...
      peg$c312 = function(funcName, modifiers, returns, parts) {
            return {
              type: "Type",
              literal: "function",
      ...
      peg$c315 = function(constant, visibility, override) {
          return {
      ...
      peg$c316 = function(constant, override, visibility) {
          return {
            visibility: visibility? visibility[0]: null,
            isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
            isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
      ...
      peg$c317 = function(override, constant, visibility) {
          return {
            visibility: visibility? visibility[0]: null,
            isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
            isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
      ...
      peg$c318 = function(override, visibility, constant) {
          return {
            visibility: visibility? visibility[0]: null,
            isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
            isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
      ...
      peg$c319 = function(visibility, override, constant) {
          return {
             visibility: visibility? visibility[0]: null,
            isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
            isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
      ...
      peg$c320 = function(visibility, constant, override) {
          return {
            visibility: visibility? visibility[0]: null,
            isconstant: constant ? (constant[0] === "constant" ? true: false) : false,
            isimmutable: constant? (constant[0] === "immutable" ? true: false) : false,
      ...
      peg$c323 = function(expression) {
          return expression;
        },
      peg$c324 = function(type, specifiers, id, value) {
          return {
      ...
      peg$c325 = function(type, storage, id) {
          return {
      ...
      peg$c329 = function(argument, operator) {
            return {
      ...
      peg$c343 = function(head, tail) { return buildBinaryExpression(head, tail); },
      peg$c344 = "*",
      ...
      peg$c390 = function(left, operator, right) {
            return {
              type:     "AssignmentExpression",
              operator: operator,
              left:     left,
      ...
      peg$c414 = function(head, tail) { return buildList(head, tail, 1); },
      peg$c415 = function(declarations) {
            return {
      ...
      peg$c417 = function(head, tail, init) {
            return {
              declarations: buildList(head, tail, 1),
              init: extractOptional(init, 1)
            }
          },
      peg$c418 = function(id) {
            return {
      ...
      peg$c420 = function(expression) { return expression; },
      peg$c421 = function() { return { type: "EmptyStatement", start: location().start.offset, end: location().end.offset }; },
      peg$c422 = function(expression, tail) {
            return {
      ...
      peg$c426 = function(tryExpression, tryStatement, catchStatements) {
            return {
               type:  "TryStatement",
      ...
      peg$c427 = function(tryExpression, tryExpressionReturns, tryStatement, catchStatements) {
              return {
               type:  "TryStatement",
      ...
      peg$c432 = function(test, consequent, alternate) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c433 = function(test, consequent) {
            return {
              type:       "IfStatement",
              test:       test,
              consequent: consequent,
      ...
      peg$c434 = function(start_version, end_version) {
          return {
      ...
      peg$c439 = function(symbols, from) {
          return {
            type: "ImportStatement",
            from: from.value,
            symbols: symbols,
      ...
      peg$c440 = function(library, type) {
          return {
            type: "UsingStatement",
      ...
      peg$c445 = function(body, test) { return { type: "DoWhileStatement", body: body, test: test, start: location().start.offset, end: location().end.offset }; },
      peg$c446 = function(test, body) { return { type: "WhileStatement", test: test, body: body, start: location().start.offset, end: location().end.offset }; },
      peg$c447 = function(init, test, update, body) {
            return {
              type:   "ForStatement",
      ...
      peg$c448 = function(declarations, test, update, body) {
            return {
              type:   "ForStatement",
              init:   {
                type:         "VariableDeclaration",
      ...
      peg$c449 = "assembly",
      peg$c450 = peg$literalExpectation("assembly", false),
      ...
      peg$c460 = function(abstract, id, is, body) {
          return {
      ...
      peg$c464 = function(fnname, isanonymous) {
          return {
      ...
      peg$c465 = function(fnname, names, body) {
            return {
      ...
      peg$c466 = function(fnname, args, returns, body) {
            return {
      ...
      peg$c467 = function(fnname, args, returns) {
            return {
              type: "FunctionDeclaration",
              name: fnname.name,
              params: fnname.params,
      ...
      peg$c468 = function(fnname, args, body) {
            return {
      ...
      peg$c469 = function(fnname, args, body) {
            return {
      ...
      peg$c470 = function(fnname, args, body) {
            return {
      ...
      peg$c471 = function(params) {
          return params != null ? params [2] : null;
        },
      peg$c472 = function(returnParams) {
      ...
      peg$c476 = function(alias, modifier) {
            if (alias.length > 0) {
      ...
      peg$c477 = function(type, isindexed, isconstant, storage, id) {
          return {
      ...
      peg$c479 = function(id, head, tail) {
          return {
      ...
      peg$c487 = function(id, params, returns, body) {
          return {
      ...
      peg$c488 = "let",
      peg$c489 = peg$literalExpectation("let", false),
      peg$c490 = ":=",
      peg$c491 = peg$literalExpectation(":=", false),
      peg$c492 = function(names, expression) {
          if (expression != null) {
      ...
      peg$c493 = function(names, expression) {
          return {
      ...
      peg$c495 = function(name, head, tail) {
          return {
      ...
      peg$c498 = function(init, test, update, body) {
          return {
            type: "AssemblyFor",
            init: init,
            test: test,
