...
function activate(context) {
    ...
    const nodeRuntime = context.executionContext === 1 ? WorkspaceRubyEnvironment_1.NodeRuntime.Electron : WorkspaceRubyEnvironment_1.NodeRuntime.Node;
    client.registerFeature(new WorkspaceRubyEnvironment_1.WorkspaceRubyEnvironmentFeature(client, nodeRuntime));
