...
class RubyDebugSession extends vscode_debugadapter_1.DebugSession {
    ...
    */
    ...
    getPathImplementation(pathToCheck) {
        if (pathToCheck) {
    ...
    convertClientPathToDebugger(localPath) {
        ...
        let relativePath = remotePathImplementation.join.apply(null, [remoteWorkspaceRoot].concat(relativeLocalPath.split(localPathImplementation.sep)));
        return relativePath;
    }
    convertDebuggerPathToClient(serverPath) {
        ...
        let relativePath = localPathImplementation.join.apply(null, [this.requestArguments.cwd].concat(relativeRemotePath.split(remotePathImplementation.sep)));
        return relativePath;
    }
    switchFrame(frameId) {
