...
var pathToResourceName = function pathToResourceName(pathValue) {
  return paths.parse(pathValue).name;
};
    ...
    switch (link.type) {
      case 'wikilink':
        ...
        if (isSome(definitionUri)) {
          ...
          targetUri = (_workspace$find$uri2 = (_workspace$find2 = workspace.find(link.slug, resource.uri)) === null || _workspace$find2 === void 0 ? void 0 : _workspace$find2.uri) !== null && _workspace$find$uri2 !== void 0 ? _workspace$find$uri2 : URI.placeholder(link.slug);
        }
      ...
      visit(tree, function (node) {
        ...
        for (var _i = 0, _len = plugins.length; _i < _len; _i++) {
          try {
            ...
            (_plugins$_i$visit = (_plugins$_i = plugins[_i]).visit) === null || _plugins$_i$visit === void 0 ? void 0 : _plugins$_i$visit.call(_plugins$_i, node, note);
          } catch (e) {
