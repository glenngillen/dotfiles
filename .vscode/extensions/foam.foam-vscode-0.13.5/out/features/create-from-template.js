...
exports.determineDefaultFilepath = exports.resolveFoamTemplateVariables = exports.substituteFoamVariables = exports.resolveFoamVariables = exports.UserCancelledOperation = void 0;
...
function determineDefaultFilepath(resolvedValues, templateMetadata) {
    let defaultFilepath;
    if (templateMetadata.get('filepath')) {
        const filepathFromMetadata = templateMetadata.get('filepath');
        if (path_1.isAbsolute(filepathFromMetadata)) {
            defaultFilepath = vscode_1.Uri.file(filepathFromMetadata);
        }
        else {
            defaultFilepath = vscode_1.Uri.joinPath(vscode_1.workspace.workspaceFolders[0].uri, filepathFromMetadata);
        }
    }
    else {
...
async function createNoteFromDefaultTemplate() {
    ...
    try {
        ...
        ] = await resolveFoamTemplateVariables(templateText, new Set(['FOAM_TITLE']));
    }
    catch (err) {
