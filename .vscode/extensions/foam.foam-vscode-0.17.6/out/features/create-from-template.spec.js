...
Template A
    ...
    describe('create-new-template', () => {
        ...
        it('should create a new template', async () => {
            const template = vscode_1.Uri.joinPath(vscode_1.workspace.workspaceFolders[0].uri, '.foam', 'templates', 'hello-world.md').fsPath;
        ...
        it('can be cancelled', async () => {
            ...
            const template = vscode_1.Uri.joinPath(vscode_1.workspace.workspaceFolders[0].uri, '.foam', 'templates', 'new-template.md').fsPath;
            vscode_1.window.showInputBox = jest.fn(() => {
