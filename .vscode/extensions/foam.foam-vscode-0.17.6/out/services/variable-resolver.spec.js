...
describe('resolveFoamVariables', () => {
    test('Does nothing for unknown Foam-specific variables', async () => {
        const variables = [new snippetParser_1.Variable('FOAM_FOO')];
    ...
    test('Resolves FOAM_TITLE', async () => {
        ...
        const variables = [new snippetParser_1.Variable('FOAM_TITLE'), new snippetParser_1.Variable('FOAM_SLUG')];
        jest
    ...
    test('Resolves FOAM_TITLE without asking the user when it is provided', async () => {
        const foamTitle = 'My note title';
        const variables = [new snippetParser_1.Variable('FOAM_TITLE')];
        const expected = new Map();
        expected.set('FOAM_TITLE', foamTitle);
        const givenValues = new Map();
    ...
    test('Resolves FOAM_DATE_* properties with current day by default', async () => {
        const variables = [
            new snippetParser_1.Variable('FOAM_DATE_YEAR'),
            new snippetParser_1.Variable('FOAM_DATE_YEAR_SHORT'),
            new snippetParser_1.Variable('FOAM_DATE_MONTH'),
            new snippetParser_1.Variable('FOAM_DATE_MONTH_NAME'),
            new snippetParser_1.Variable('FOAM_DATE_MONTH_NAME_SHORT'),
            new snippetParser_1.Variable('FOAM_DATE_DATE'),
            new snippetParser_1.Variable('FOAM_DATE_DAY_NAME'),
            new snippetParser_1.Variable('FOAM_DATE_DAY_NAME_SHORT'),
            new snippetParser_1.Variable('FOAM_DATE_HOUR'),
            new snippetParser_1.Variable('FOAM_DATE_MINUTE'),
            new snippetParser_1.Variable('FOAM_DATE_SECOND'),
            new snippetParser_1.Variable('FOAM_DATE_SECONDS_UNIX'),
        ];
        const expected = new Map();
