...
class SourceMappingDecoder {
    constructor() {
         ...
         */
        this.decompressAll = function (mapping) {
         ...
         */
        this.getLinebreakPositions = function (source) {
            const ret = [];
         ...
         */
        this.convertOffsetToLineColumn = function (sourceLocation, lineBreakPositions) {
    ...
    convertFromCharPosition(pos, lineBreakPositions) {
        let line = srcmap_1.findLowerBound(pos, lineBreakPositions);
