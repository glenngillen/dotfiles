...
class SolcCompiler {
    ...
    compileSolidityDocumentAndGetDiagnosticErrors(filePath, documentText, packageDefaultDependenciesDirectory, packageDefaultDependenciesContractsDirectory, selectedCompiler = null) {
        if (selectedCompiler == null) {
            selectedCompiler = this.selectedCompiler;
        }
