...
**generateNetStandardClassLibrary** Generates the NetStandard class library using the "projectName" and "Path";
**generateAllClasses** Generates all classes using the "abi", "byteCode", "contractName", optional "namespace", "path" and language.

The languages ids are: 0 for CSharp, 1 for Vb.Net and 3 for FSharp
