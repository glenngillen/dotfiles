...
connection.onInitialize((params) => __awaiter(this, void 0, void 0, function* () {
    ...
    let nodeRuntime = params.initializationOptions ? params.initializationOptions.runtime : rebuilder_1.NodeRuntime.Electron;
    connection.console.info(`Rebuilding tree-sitter for local ${nodeRuntime === rebuilder_1.NodeRuntime.Electron ? 'Electron' : 'Node.js'} version`);
    const rebuildResult = yield rebuilder_1.rebuildTreeSitter(nodeRuntime);
