...
describe('getDailyNotePath', () => {
    ...
    test('Adds the root directory to relative directories', async () => {
        ...
        const expectedPath = vscode_1.Uri.joinPath(vscode_1.workspace.workspaceFolders[0].uri, config, `${isoDate}.md`);
        ...
        expect(foam_core_1.URI.toFsPath(dated_notes_1.getDailyNotePath(foamConfiguration, date))).toEqual(expectedPath.fsPath);
    });
